...
| Posts & Content | `posts_content.md` | Public/admin post APIs, gated content theo role level, tag/category/file/image/view/reaction. |
...
| Admin RBAC | `admin_rbac.md` | Role, permission, user lock, permission blacklist và admin user-management endpoints. |
