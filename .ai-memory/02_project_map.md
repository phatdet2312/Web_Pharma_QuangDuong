...
| Services interfaces | `src/main/java/.../service/itf` | Hợp đồng business service | `IUserService`, `IPostService`, `IEventService`, `ICommentService`, `IProfileService`, `IAddressService`, `IEmailService`, `IAuditService`, `IAdminPostService`, `IAdminEventService`, `IAdminReportService`, `IPublicReportService`, `IRoleManagementService`, `IRolesService`, `ISpeakerAgendaService`, `IUserTrackingService` |
